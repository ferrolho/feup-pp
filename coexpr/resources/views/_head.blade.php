<head>
	...
	<!-- Template CSS -->
	<link href="{{ url('css/landing-page.css') }}" rel="stylesheet" type="text/css">

	<!-- CoExpr -->
	<link href="{{ url('css/coexpr/coexpr.css') }}" rel="stylesheet">
	<link href="{{ url('css/coexpr/loading.css') }}" rel="stylesheet">
